...
class Ui_NullpoTracker(object):
    def setupUi(self, NullpoTracker):
        ...
        self.FromDTNowButton = QtWidgets.QPushButton(self.FromSelector)
        self.FromDTNowButton.setGeometry(QtCore.QRect(40, 0, 31, 19))
        self.FromDTNowButton.setObjectName("FromDTNowButton")
        ...
        self.ToDTNowButton = QtWidgets.QPushButton(self.ToSelector)
        self.ToDTNowButton.setGeometry(QtCore.QRect(40, 0, 31, 19))
        self.ToDTNowButton.setObjectName("ToDTNowButton")
        self.gameTracker = QtWidgets.QTableWidget(self.Window)
        self.gameTracker.setGeometry(QtCore.QRect(10, 70, 551, 521))
        self.gameTracker.setColumnCount(8)
        ...
        self.selectionScore = QtWidgets.QWidget(self.SelectionFrame)
        self.selectionScore.setGeometry(QtCore.QRect(10, 110, 200, 21))
        self.selectionScore.setObjectName("selectionScore")
        self.selectionScoreName = QtWidgets.QLabel(self.selectionScore)
        self.selectionScoreName.setGeometry(QtCore.QRect(0, 0, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.selectionScoreName.setFont(font)
        self.selectionScoreName.setObjectName("selectionScoreName")
        self.selectionScoreStat = QtWidgets.QLabel(self.selectionScore)
        self.selectionScoreStat.setGeometry(QtCore.QRect(50, 0, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.selectionScoreStat.setFont(font)
        self.selectionScoreStat.setObjectName("selectionScoreStat")
    ...
    def retranslateUi(self, NullpoTracker):
        ...
        self.FromDTNowButton.setText(_translate("NullpoTracker", "Now"))
        self.ToDTNowButton.setText(_translate("NullpoTracker", "Now"))
        ...
        self.selectionScoreName.setText(
            _translate("NullpoTracker", "Score:"))
        self.selectionScoreStat.setText(
            _translate("NullpoTracker", ""))
